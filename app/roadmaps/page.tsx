  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <nav className="border-b border-zinc-900 sticky top-0 bg-zinc-950/95 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <span className="text-zinc-400">Roadmaps</span>
          </div>
          <button
            onClick={toggleTheme}
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <p className="text-zinc-400 text-sm mb-4">Execution Planning</p>
        <h1 className="text-4xl font-light tracking-tight mb-2">Roadmaps</h1>
        <p className="text-zinc-400 mb-12">
          Quarterly execution timelines, milestones, and planning documents.
        </p>
